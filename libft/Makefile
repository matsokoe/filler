...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/05/21 10:23:47 by matsokoe          #+#    #+#              #
#    Updated: 2019/06/12 17:47:38 by matsokoe         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	  ...
	  ft_strjoin.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o \
	  ft_putstr_fd.o ft_putchar_fd.o ft_putendl_fd.o ft_putnbr_fd.o \
	  ft_strtrim.o ft_itoa.o ft_strsplit.o ft_lstnew.o ft_lstdelone.o \
